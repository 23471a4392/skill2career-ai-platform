// Peer Learning, Mentorship Matching & Code Review Pairing Service
...
export class Mentorshipservice {
  ...
  public static getInstance(): Mentorshipservice {
...
export const mentorshipServiceInstance = Mentorshipservice.getInstance();
