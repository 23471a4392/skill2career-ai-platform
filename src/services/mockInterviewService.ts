// AI-Assisted Technical and Behavioral Mock Interview Simulation Service
...
export class Mockinterviewservice {
  ...
  public static getInstance(): Mockinterviewservice {
...
export const mockInterviewServiceInstance = Mockinterviewservice.getInstance();
