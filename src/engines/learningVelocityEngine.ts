// Bayesian Knowledge Tracing & Learning Velocity Estimator
...
export class Learningvelocityengine {
  ...
  public static getInstance(): Learningvelocityengine {
...
export const learningVelocityEngineInstance = Learningvelocityengine.getInstance();
