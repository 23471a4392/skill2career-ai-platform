// ATS Resume Keyword Matcher, Cosine Similarity & Scoring Engine
...
export class Resumeatsengine {
  private static instance: Resumeatsengine;
  private cache: Map<string, unknown> = new Map();

  private constructor() {}

  public static getInstance(): Resumeatsengine {
    if (!Resumeatsengine.instance) {
      Resumeatsengine.instance = new Resumeatsengine();
    }
    return Resumeatsengine.instance;
  }
...
export const resumeAtsEngineInstance = Resumeatsengine.getInstance();
